...
[`infra/llm-layer/README.md`](../../infra/llm-layer/README.md).
...
| Responsibility | File |
|---|---|
| Application stack | `infra/llm-layer/template.yaml` |
| OIDC roles and artifact bucket | `infra/llm-layer/deploy/github-actions-bootstrap.yaml` |
| Replacement/deletion protection | `infra/llm-layer/deploy/application-stack-policy.json` |
