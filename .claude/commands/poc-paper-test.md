...
demos/dday-simulation/poc/PAPER-TEST.md 를 읽고, 그 지침을 **문자 그대로** 따라
페이퍼 테스트를 실행하라. 세계 데이터는 demos/dday-simulation/poc/slice.json.
...
- 산출물은 demos/dday-simulation/poc/runs/ 와 RESULTS.md 에 남긴다.
