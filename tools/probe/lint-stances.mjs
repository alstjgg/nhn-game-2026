...
// One flat roster for every call type — see prompts.mjs.
const tempPath = join(PROMPTS.temperamentRoot, `${suite.temperament}.md`);
...
console.log(`temperament ${suite.temperament}  (${tempPath.replace(`${REPO}/`, '')})`);
