...
//
//   node infra/scenario-pipeline/generate-datapack-types.mjs          # write
//   node infra/scenario-pipeline/generate-datapack-types.mjs --check  # exit 1 on drift
//
...
if (process.argv.includes('--check')) {
  ...
  if (current !== out) {
    console.error('✗ src/shared/datapack.ts is stale — regenerate: node infra/scenario-pipeline/generate-datapack-types.mjs');
    process.exit(1);
  }
