...
| Responsibility | File |
|---|---|
| API Gateway, Lambda, and runtime IAM | `planning/legacy-services/apothecary-llm-layer/template.yaml` |
| Environment configuration validation | `planning/legacy-services/apothecary-llm-layer/src/config.ts` |
| HTTP routing and CORS | `planning/legacy-services/apothecary-llm-layer/src/handler.ts` |
| Bedrock Converse call | `planning/legacy-services/apothecary-llm-layer/src/dialogue-provider.ts` |
| Prompt and tool schema | `planning/legacy-services/apothecary-llm-layer/src/dialogue-prompt.ts`, `planning/legacy-services/apothecary-llm-layer/src/dialogue-schema.ts` |
| Request and response validation | `planning/legacy-services/apothecary-llm-layer/src/dialogue-validation.ts` |
| Deterministic fallback | `planning/legacy-services/apothecary-llm-layer/src/dialogue-fallback.ts` |
| Server allowlisted game data | `planning/legacy-services/apothecary-llm-layer/data/apothecary.ts` |
| GitHub OIDC roles and artifact bucket | `planning/legacy-services/apothecary-llm-layer/deploy/github-actions-bootstrap.yaml` |
| Application stack replacement/deletion protection | `planning/legacy-services/apothecary-llm-layer/deploy/application-stack-policy.json` |
...
```bash
cd planning/legacy-services/apothecary-llm-layer
npm ci
npm run check
...
See `planning/legacy-services/apothecary-llm-layer/scripts/dialogue-smoke.mjs` for a complete request using
...
Deployment defaults live in `planning/legacy-services/apothecary-llm-layer/samconfig.toml`.
